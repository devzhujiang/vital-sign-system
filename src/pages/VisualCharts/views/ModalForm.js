...
const mapPropsToFields = (props) =>{
    ...
    if(JSON.stringify(props.visualCharts.planDetails) === '{}'){
        ...
        obj.name = props.visualCharts.planDetails.plan.name
        obj.name2 = props.visualCharts.planDetails.items[0].val
        obj.name3 = props.visualCharts.planDetails.items[1].isFocus === 0 ? false : true
        obj.name4 = props.visualCharts.planDetails.items[1].val
        obj.name5 = props.visualCharts.planDetails.items[2].isFocus === 0 ? false : true
        obj.name6 = props.visualCharts.planDetails.items[2].val
        obj.name7 = props.visualCharts.planDetails.items[3].val
        obj.name8 = props.visualCharts.planDetails.items[4].isFocus === 0 ? false : true
        obj.name9 = props.visualCharts.planDetails.items[4].val
        obj.name10 = props.visualCharts.planDetails.items[5].isFocus === 0 ? false : true
        obj.name11 = props.visualCharts.planDetails.items[5].val
        obj.name12 = props.visualCharts.planDetails.items[6].isFocus === 0 ? false : true
        obj.name13 = props.visualCharts.planDetails.items[6].val
        obj.name14 = props.visualCharts.planDetails.items[7].isFocus === 0 ? false : true
        obj.name15 = props.visualCharts.planDetails.items[7].status
        obj.name16 = props.visualCharts.planDetails.items[7].val
    }
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name3',{
                                            initialValue: JSON.stringify(this.props.visualCharts.planDetails) === '{}' ? 0 : this.props.visualCharts.planDetails.items[1].isFocus === 0 ? false : true,
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name5',{
                                            initialValue: JSON.stringify(this.props.visualCharts.planDetails) === '{}' ? 0 : this.props.visualCharts.planDetails.items[2].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name8',{
                                            initialValue: JSON.stringify(this.props.visualCharts.planDetails) === '{}' ? 0 : this.props.visualCharts.planDetails.items[4].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name10',{
                                            initialValue: JSON.stringify(this.props.visualCharts.planDetails) === '{}' ? 0 : this.props.visualCharts.planDetails.items[5].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name12',{
                                            initialValue: JSON.stringify(this.props.visualCharts.planDetails) === '{}' ? 0 : this.props.visualCharts.planDetails.items[6].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name14',{
                                            initialValue: JSON.stringify(this.props.visualCharts.planDetails) === '{}' ? 0 : this.props.visualCharts.planDetails.items[7].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
