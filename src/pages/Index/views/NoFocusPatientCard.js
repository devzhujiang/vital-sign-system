                                    ...
                                    return(
                                        <React.Fragment key={item.id}>
                                            ...
                                            >
                                                ...
                                                <div className={ item.device ? item.device.timeStamp ? (((!__.inRange(item.device.heartbeat, 60, 80)) || (!__.inRange(item.device.breath, 12, 20))) ? 'cardTopGreen' : 'cardTopSpe') : 'cardTopSpe' : 'cardTopSpe'    }>
