...
const mapPropsToFields = (props) =>{
    let obj = {}
    obj.name = props.warningDetails.planDetails.plan.name
    obj.name2 = props.warningDetails.planDetails.items[0].val
    obj.name3 = props.warningDetails.planDetails.items[1].isFocus === 0 ? false : true
    obj.name4 = props.warningDetails.planDetails.items[1].val
    obj.name5 = props.warningDetails.planDetails.items[2].isFocus === 0 ? false : true
    obj.name6 = props.warningDetails.planDetails.items[2].val
    obj.name7 = props.warningDetails.planDetails.items[3].val
    obj.name8 = props.warningDetails.planDetails.items[4].isFocus === 0 ? false : true
    obj.name9 = props.warningDetails.planDetails.items[4].val
    obj.name10 = props.warningDetails.planDetails.items[5].isFocus === 0 ? false : true
    obj.name11 = props.warningDetails.planDetails.items[5].val
    obj.name12 = props.warningDetails.planDetails.items[6].isFocus === 0 ? false : true
    obj.name13 = props.warningDetails.planDetails.items[6].val
    obj.name14 = props.warningDetails.planDetails.items[7].isFocus === 0 ? false : true
    obj.name15 = props.warningDetails.planDetails.items[7].status
    obj.name16 = props.warningDetails.planDetails.items[7].val
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name3',{
                                            initialValue: this.props.warningDetails.planDetails.items[1].isFocus === 0 ? false : true,
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name5',{
                                            initialValue: this.props.warningDetails.planDetails.items[2].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name8',{
                                            initialValue: this.props.warningDetails.planDetails.items[4].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name10',{
                                            initialValue: this.props.warningDetails.planDetails.items[5].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name12',{
                                            initialValue: this.props.warningDetails.planDetails.items[6].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                ...
                                <span className="firseItem">
                                    <FormItem>
                                        {getFieldDecorator('name14',{
                                            initialValue: this.props.warningDetails.planDetails.items[7].isFocus === 0 ? false : true,
                                            valuePropName: 'checked',
                                        })(
                                            <Checkbox></Checkbox>
                                        )}
                                    ...
                                    <span>
                                        <FormItem>
                                            ...
                                            {getFieldDecorator('name16', {
                                                initialValue: this.props.warningDetails.planDetails.items[7].val,
                                                rules: [{
                                                    required: true,
                                                    message: '请输入间隔时长',
                                                }],
...
export default Form.create({mapPropsToFields})(connect(mapStateToProps, mapDispatchToProps)(FormSearch))
